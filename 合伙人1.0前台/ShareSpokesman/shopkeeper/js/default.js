...
var order = Vue.extend({
    ...
    methods : {
        ...
        _addPolicy : function(){
            ...
            data.weight = 0;
            data.original_price = _this.base.database.original_price * _this.base.database.number;
            data.gd_no = "-";
            data.autograph = _this.base.database.realname;
            data.gd_image = _this.base.database.title_pic;
            data.shop_name = _this.base.database.name;
            data.shop_address = _this.base.database.shop_address;
            console.log(data)
        ...
        _getManagerId : function(){
            ...
            _this.$http.post(url, data ,{emulateJSON:true}).then(function(response){
                ...
                if( result.error_code == 0 ){
                    ...
                    _this.base.is_shopowner = result.data[0].is_shopowner;

...
var invite = Vue.extend({
    ...
    methods : {
        _wechatShare:function () {
            var _this = this;
            var url;           
            var host = window.location.href.split('#')[0] + "#!/join";
            // host = host + "&page=join";
            $.ajax({
                async: false,
                url: "http://weixin.echao.com/api/jssdk_access.php",
    ...
    ready : function(){
        ...
        _this.parentMsg = _this.parent;
        _this.base.token = sessionStorage.getItem("token");
        // if( _this.base.reload ){
        //     location.reload();
        // }
        // if( getURLParam("from",host.split("#!/")[0]) ){
        //     shareurl = delUrlParam(host.split("#!/")[0],"from");
        //     return location.href = shareurl + "#!/" + host.split("#!/")[1];
        // }
        // if( getURLParam("isappinstalled",host.split("#!/")[0]) ){
        //     shareurl = delUrlParam(host.split("#!/")[0],"isappinstalled");
        //     return location.href = shareurl + "#!/" + host.split("#!/")[1];
        // }
        userLogin(function(){
            setTimeout(function(){
